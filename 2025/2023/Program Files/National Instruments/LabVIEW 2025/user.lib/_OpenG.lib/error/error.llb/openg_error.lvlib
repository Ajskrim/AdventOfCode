...
<Library LVVersion="23008000">
	...
	<Item Name="poly_members" Type="Folder">
		<Item Name="Filter Error Codes (Array)__ogtk.vi" Type="VI" URL="../Filter Error Codes (Array)__ogtk.vi"/>
		<Item Name="Filter Error Codes (Scalar)__ogtk.vi" Type="VI" URL="../Filter Error Codes (Scalar)__ogtk.vi"/>
	</Item>
	<Item Name="typedefs" Type="Folder">
		<Item Name="Filtered Error Details - Cluster__ogtk.ctl" Type="VI" URL="../Filtered Error Details - Cluster__ogtk.ctl"/>
	</Item>
	<Item Name="Build Error Cluster__ogtk.vi" Type="VI" URL="../Build Error Cluster__ogtk.vi"/>
	<Item Name="Case (Error IO)__ogtk.vi" Type="VI" URL="../Case (Error IO)__ogtk.vi"/>
	<Item Name="Clear All Errors__ogtk.vi" Type="VI" URL="../Clear All Errors__ogtk.vi"/>
	<Item Name="Error Codes Ring Constant__ogtk.vi" Type="VI" URL="../Error Codes Ring Constant__ogtk.vi"/>
	<Item Name="Error Constant__ogtk.vi" Type="VI" URL="../Error Constant__ogtk.vi"/>
	<Item Name="Filter Error Codes__ogtk.vi" Type="VI" URL="../Filter Error Codes__ogtk.vi"/>
</Library>
